...
export const ui = {
  en: {
    ...
    'weeklist.subtitle': 'Plan your week, send tasks to Timer',
    'weeklist.currentWeek': 'Current Week',
    'weeklist.nextWeek': 'Next Week',
    'weeklist.swapWeeks': 'Swap Weeks',
    'weeklist.day1': 'Day 1',
    'weeklist.day2': 'Day 2',
    'weeklist.day3': 'Day 3',
    'weeklist.day4': 'Day 4',
    ...
    'weeklist.day6': 'Day 6',
    'weeklist.day7': 'Day 7',
    'weeklist.addTask': 'Add a task...',
    'weeklist.aria.delete': 'Delete task',
    'weeklist.aria.send': 'Send task to Timer',
    'weeklist.aria.sendDay': 'Send all day tasks to Timer',
    'weeklist.aria.redo': 'Reset linked Timer task to pending',
    'weeklist.sentToast': 'Sent to On Screen Timer',
  ...
  es: {
    ...
    'weeklist.subtitle': 'Planifica tu semana, envía tareas al Temporizador',
    'weeklist.currentWeek': 'Semana Actual',
    'weeklist.nextWeek': 'Próxima Semana',
    'weeklist.swapWeeks': 'Intercambiar Semanas',
    'weeklist.day1': 'Día 1',
    'weeklist.day2': 'Día 2',
    'weeklist.day3': 'Día 3',
    'weeklist.day4': 'Día 4',
    ...
    'weeklist.day6': 'Día 6',
    'weeklist.day7': 'Día 7',
    'weeklist.addTask': 'Añadir una tarea...',
    'weeklist.aria.delete': 'Eliminar tarea',
    'weeklist.aria.send': 'Enviar tarea al Temporizador',
    'weeklist.aria.sendDay': 'Enviar todas las tareas del día',
    'weeklist.aria.redo': 'Restablecer tarea vinculada',
    'weeklist.sentToast': 'Enviado a On Screen Timer',
  ...
  'pt-br': {
    ...
    'weeklist.subtitle': 'Planeje sua semana, envie tarefas para o On Screen Timer',
    'weeklist.currentWeek': 'Semana Atual',
    'weeklist.nextWeek': 'Próxima Semana',
    'weeklist.swapWeeks': 'Trocar Semanas',
    'weeklist.day1': 'Dia 1',
    'weeklist.day2': 'Dia 2',
    'weeklist.day3': 'Dia 3',
    'weeklist.day4': 'Dia 4',
    ...
    'weeklist.day6': 'Dia 6',
    'weeklist.day7': 'Dia 7',
    'weeklist.addTask': 'Adicionar uma tarefa...',
    'weeklist.aria.delete': 'Excluir tarefa',
    'weeklist.aria.send': 'Enviar tarefa para o On Screen Timer',
    'weeklist.aria.sendDay': 'Enviar todas as tarefas do dia',
    'weeklist.aria.redo': 'Redefinir tarefa vinculada',
    'weeklist.sentToast': 'Enviado para On Screen Timer',
  },
  fr: {
    // Nav / Header
    'nav.tools': 'Outils',
    ...
    'weeklist.subtitle': 'Planifiez votre semaine, envoyez des tâches au Minuteur',
    'weeklist.currentWeek': 'Semaine Actuelle',
    'weeklist.nextWeek': 'Semaine Prochaine',
    'weeklist.swapWeeks': 'Échanger les Semaines',
    'weeklist.day1': 'Jour 1',
    'weeklist.day2': 'Jour 2',
    'weeklist.day3': 'Jour 3',
    'weeklist.day4': 'Jour 4',
    'weeklist.day5': 'Jour 5',
    'weeklist.day6': 'Jour 6',
    'weeklist.day7': 'Jour 7',
    'weeklist.addTask': 'Ajouter une tâche…',
    'weeklist.aria.delete': 'Supprimer la tâche',
    'weeklist.aria.send': 'Envoyer la tâche au Minuteur',
    'weeklist.aria.sendDay': 'Envoyer toutes les tâches du jour',
    'weeklist.aria.redo': 'Réinitialiser la tâche liée',
    'weeklist.sentToast': 'Envoyé à On Screen Timer',
  ...
  it: {
    ...
    'weeklist.subtitle': 'Pianifica la tua settimana, invia compiti al Timer',
    'weeklist.currentWeek': 'Settimana Corrente',
    'weeklist.nextWeek': 'Prossima Settimana',
    'weeklist.swapWeeks': 'Scambia Settimane',
    'weeklist.day1': 'Giorno 1',
    'weeklist.day2': 'Giorno 2',
    'weeklist.day3': 'Giorno 3',
    'weeklist.day4': 'Giorno 4',
    'weeklist.day5': 'Giorno 5',
    'weeklist.day6': 'Giorno 6',
    'weeklist.day7': 'Giorno 7',
    'weeklist.addTask': 'Aggiungi un\'attività...',
    'weeklist.aria.delete': 'Elimina compito',
    'weeklist.aria.send': 'Invia compito al Timer',
    'weeklist.aria.sendDay': 'Invia tutti i compiti del giorno',
    'weeklist.aria.redo': 'Reimposta compito collegato',
    'weeklist.sentToast': 'Inviato a On Screen Timer',
  ...
  ja: {
    ...
    'weeklist.subtitle': '週の予定を立て、タスクをタイマーに送信します',
    'weeklist.currentWeek': '今週',
    'weeklist.nextWeek': '来週',
    'weeklist.swapWeeks': '週を入れ替える',
    'weeklist.day1': '1日目',
    'weeklist.day2': '2日目',
    'weeklist.day3': '3日目',
    'weeklist.day4': '4日目',
    ...
    'weeklist.day6': '6日目',
    'weeklist.day7': '7日目',
    'weeklist.addTask': 'タスクを追加...',
    'weeklist.aria.delete': 'タスクを削除',
    'weeklist.aria.send': 'タスクをタイマーに送信',
    'weeklist.aria.sendDay': '1日のすべてのタスクを送信',
    'weeklist.aria.redo': 'リンクされたタスクをリセット',
    ...
    'weeklist.aria.sendDay': '1日のすべてのタスクを送信',
    'weeklist.aria.redo': 'リンクされたタスクをリセット',
    'weeklist.sentToast': 'On Screen Timer に送信しました',
  },
  de: {
    // Nav / Header
    'nav.tools': 'Werkzeuge',
    ...
    'weeklist.subtitle': 'Plane deine Woche, sende Aufgaben an den Timer',
    'weeklist.currentWeek': 'Aktuelle Woche',
    'weeklist.nextWeek': 'Nächste Woche',
    'weeklist.swapWeeks': 'Wochen tauschen',
    'weeklist.day1': 'Tag 1',
    'weeklist.day2': 'Tag 2',
    'weeklist.day3': 'Tag 3',
    'weeklist.day4': 'Tag 4',
    ...
    'weeklist.day6': 'Tag 6',
    'weeklist.day7': 'Tag 7',
    'weeklist.addTask': 'Aufgabe hinzufügen...',
    'weeklist.aria.delete': 'Aufgabe löschen',
    'weeklist.aria.send': 'Aufgabe an Timer senden',
    'weeklist.aria.sendDay': 'Alle Aufgaben des Tages senden',
    'weeklist.aria.redo': 'Verknüpfte Aufgabe zurücksetzen',
    'weeklist.sentToast': 'An On Screen Timer gesendet',
  ...
  ko: {
    ...
    'weeklist.subtitle': '주간 계획을 세우고 타이머로 작업을 보냅니다',
    'weeklist.currentWeek': '이번 주',
    'weeklist.nextWeek': '다음 주',
    'weeklist.swapWeeks': '주 교환',
    'weeklist.day1': '1일차',
    'weeklist.day2': '2일차',
    'weeklist.day3': '3일차',
    'weeklist.day4': '4일차',
    ...
    'weeklist.day6': '6일차',
    'weeklist.day7': '7일차',
    'weeklist.addTask': '작업 추가...',
    'weeklist.aria.delete': '작업 삭제',
    'weeklist.aria.send': '타이머로 작업 보내기',
    'weeklist.aria.sendDay': '해당 일의 모든 작업 보내기',
    'weeklist.aria.redo': '연결된 작업 초기화',
    'weeklist.sentToast': 'On Screen Timer로 전송됨',
